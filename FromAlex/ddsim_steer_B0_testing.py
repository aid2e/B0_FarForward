...
#SIM.outputFile = "B0_field_map_20cm_shift_11_13_2023_JIHEE.root"
#SIM.outputFile = "coherent_Au_new_vacuum_world_volume_Air_9_12_2023.edm4hep.root"
...
SIM.gun.momentumMin = 80.0*GeV
SIM.gun.momentumMax = 100.0*GeV
...
SIM.gun.particle = "proton" #proton
#SIM.gun.particle = "2212"
##SIM.gun.phiMax = pi
...
SIM.gun.thetaMin = 0.006*radian
# Max can be 13 mrad
SIM.gun.thetaMax = 0.013*radian # Full 25 does not hit the tracker compleletly. 
